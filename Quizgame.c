...
mainhome:
	...
	{	printf("\nScore card is empty please play the quiz");
		viewscore();
		goto help;
	}
...
home:
	...
	for (i = 1; i <= 10; i++)
	{
		...
		case 4:
		{
			printf("\n\n\n4) Who was awarded the youngest player award in Fifa World Cup 2006?");
		...
		case 7:
		{
			printf("\n\n7) What is the National Game of England?");
		...
		//eigth question
		case 8:
			printf("\n\n\n8) Ozone plate is being destroyed regularly because of____ ?");
			printf("\n\nA) L.P.G\t\tB) Nitrogen\n\nC) Methane\t\tD)  C) F.C\n\n");
			scanf(" %c", &choice);
			if (choice == 'd' || choice == 'D')
			{
		...
		//ninth question
		case 9:
			printf("\n\n\n9) Which film was awarded the Best Motion Picture at Oscar in 2010?");
		...
		//tenth question
		case 10:
			printf("\n\n\n10) Which hardware was used in the First Generation Computer?");
...
exit:
printf("Thanks for attending you can also win 1 crore\n");
}
